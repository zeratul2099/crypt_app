...
urlpatterns = [
    ...
    url(r'^kryptos/info/(?P<algo_name>\w*)/(?P<page>\w*)/?$', base_views.info, name='info'),
    url(r'^kryptos/algo/hash/(?P<algo_name>\w*)/?$', hash_views.algo, name='hash_algo'),
    # (r'^kryptos/algo/stego/(?P<algo_name>\w*)/?$', stego_views.algo, name='stego_algo'),
    url(r'^kryptos/algo/crypto/(?P<algo_name>\w*)/?$', crypto_views.algo, name='crypto_algo'),
